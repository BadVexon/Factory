...
public class MyAct implements
    ...
    public void receivePostInitialize() {
        ...
        */
        ...
        BaseMod.addEvent(WowGold.ID, WowGold.class, Factory.ID);
        ...
        // Bosses
        BaseMod.addMonster(FactoryEncounterIDList.GUARDIAN_2_ENCOUNTER_ID, () -> new MonsterGroup(new AbstractMonster[]{
                new SnakeHead(-450.0F, 250.0F),
                new SnakeSegment(-300.0F, 200.0F),
                new SnakeSegment(-250.0F, 170.0F),
                new SnakeSegment(-200.0F, 140.0F),
                new SnakeSegment(-150.0F, 110.0F),
                new SnakeSegment(-100.0F, 80.0F),
                new SnakeSegment(-50.0F, 50.0F),
                new SnakeSegment(0.0F, 20.0F),
                new SnakeSegment(50.0F, 10.0F),
                new SnakeTail(200.0F, 0.0F)
        }));
        ...
        // Add bosses here
        BaseMod.addBoss(Factory.ID, SnakeHead.ID, "superResources/images/map/GUARDIAN2Outline.png", "superResources/images/map/GUARDIAN2.png");
        BaseMod.addBoss(Factory.ID, SPIDER.ID, "superResources/images/map/SPIDER.png", "superResources/images/map/SPIDEROutline.png"); // A R T
